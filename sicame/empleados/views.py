...
class VerEmocionesViewSet(ModelViewSet):
    """
    Vista que permite ver los reportes de los empleados

    - Recibe una solictud GET del cliente
    - Retorna la información de los reportes

    Args:
        request: La solicitud HTTP que solicita el reporte de los empleados.
    Returns:
        Response: Respuesta con los datos de los empleados.
    """
